...
```bash
curl -LO https://github.com/mxssl/doh/releases/download/v0.0.21/doh_linux_amd64.tar.gz
...
```bash
curl -LO https://github.com/mxssl/doh/releases/download/v0.0.21/doh_linux_arm64.tar.gz
...
```bash
curl -LO https://github.com/mxssl/doh/releases/download/v0.0.21/doh_darwin_arm64.tar.gz
...
```bash
docker pull mxssl/doh:v0.0.21
docker container run --rm mxssl/doh:v0.0.21 a google.com
```
