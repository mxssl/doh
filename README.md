...
```bash
wget https://github.com/mxssl/doh/releases/download/v0.0.11/doh_linux_amd64.tar.gz
...
```bash
wget https://github.com/mxssl/doh/releases/download/v0.0.11/doh_darwin_amd64.tar.gz
...
```bash
wget https://github.com/mxssl/doh/releases/download/v0.0.11/doh_darwin_arm64.tar.gz
...
```bash
docker pull mxssl/doh:v0.0.11
docker container run --rm mxssl/doh:v0.0.11 doh a google.com
```
